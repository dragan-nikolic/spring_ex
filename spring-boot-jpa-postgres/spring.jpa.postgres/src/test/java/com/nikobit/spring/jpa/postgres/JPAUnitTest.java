package com.nikobit.spring.jpa.postgres;
...
import com.nikobit.spring.jpa.postgres.repository.TutorialRepository;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;

/**
 * @Transactional disables transactional tests
 * @AutoConfigureTestDatabase configure to use real database
 *
 * Test will work only if you start with empty database and comment out @Transactional.
 * You need to start real postgres db before running tests.
 */
